...
for(int i=0;i<candidateList.size();i++){
	...
	else {System.out.print(candidateList.get(i).getId());System.out.println(",-1");}
	}
	...
	//////////////////////////////tmpfunchere////////////////////////////////
	public void display(){
		for(int j=0;j<candidateList.size();j++) candidateList.get(j).displayPref();
		for(int i=0;i<meritList.getMeritList().length;i++){
			 System.out.println(meritList.getMeritList()[i].getId());
	}
